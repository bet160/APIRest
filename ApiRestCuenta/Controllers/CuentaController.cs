...
namespace ApiRestCuenta.Controllers
{
    ...
    public class CuentaController : Controller
    {
        ...
        public Cuenta Get(string usuario, string contrasenia)
        {
            var cuenta = context.Cuenta.Where(x => x.usuario == usuario && x.contraseña == contrasenia).FirstOrDefault();
